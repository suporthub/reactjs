...
const translations = {
    english: {
        ...
        accountType: 'Select Group',
        selectAccount: 'Select Group',
        signup: 'Sign Up',
    ...
    hindi: {
        ...
        accountType: 'ग्रुप चुनें',
        selectAccount: 'ग्रुप चुनें',
        signup: 'साइन अप करें',
    ...
    vietnam: {
        ...
        accountType: 'Chọn nhóm',
        selectAccount: 'Chọn nhóm',
        signup: 'Đăng ký',
    ...
    indonesian: {
        ...
        accountType: 'Pilih Grup',
        selectAccount: 'Pilih Grup',
        signup: 'Daftar',
    ...
    arabic: {
        ...
        accountType: 'اختر المجموعة',
        selectAccount: 'اختر المجموعة',
        signup: 'تسجيل',
    ...
    urdu: {
        ...
        accountType: 'گروپ منتخب کریں',
        selectAccount: 'گروپ منتخب کریں',
        signup: 'سائن اپ کریں',
                        ...
                        <div className="form-group">
                            ...
                            {accountKind === 'live' ? (
                                ...
                                >
                                    ...
                                    <option value="cent">{t.cent}</option>
